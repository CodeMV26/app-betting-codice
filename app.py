...
<div class="brand-box">
    ...
    <div class="version-label">Versione Progetto: 5.67</div>
</div>
""", unsafe_allow_html=True)

# Banner informativo di tracciamento Cloud (Geometria iPhone Protetta)
st.info(f"📍 Ambiente Server Cloud Attivo: `/mount/src/app-betting-codice`")
