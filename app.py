...
# --- RESTYLING GRAFICO ULTRA-OTTIMIZZATO (VERSIONE ALLINEATA) ---
st.markdown("""
    <style>
    .block-container { 
...
<div class="brand-box">
    ...
    <div class="version-label">Versione Progetto: 5.73</div>
</div>
""", unsafe_allow_html=True)

# --- I 3 PULSANTI VERTICALI DI AZIONE (CHIAMATE MODULI ESTERNI RIPRISTINATE) ---
...
# --- MICRO-TAB ORIZZONTALIZZATI PER IPHONE ---
...
if dict_acc:
    st.markdown('<div class="accuracy-container"><div class="accuracy-title">📈 Performance Reale Dixon-Coles (12 Mercati)</div><div class="accuracy-grid">', unsafe_allow_html=True)
...
# --- RENDERING INTERFACCIA INTEGRALE ---
